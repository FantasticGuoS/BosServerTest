package com.sungeon.bos.logging;
...
/**
 * TimeSizeRollingFileAppender extends {@link FileAppender} so that the
...
public class TimeSizeRollingFileAppender extends FileAppender {
	...
	/**
	 * The date pattern. By default, the pattern is set to "'.'yyyy-MM-dd'.log'"
